...
#else
static void fixup_func(struct tasklet_struct *ts)
#endif
{
...
int pon_serdes_lof_fixup_cfg(pon_serdes_lof_fixup_fifo_t *_fifo_cb, void (*reset_cb)(void), void (*pmd_rx_restart_cb)(void), void (*reset_rx_fifo_cb)(void), void (*reset_tx_fifo_cb)(void), void (*reset_gb_cb)(void))
{
    if (_fifo_cb)
        fifo_cb = *_fifo_cb;
    reset_cdr = reset_cb;
